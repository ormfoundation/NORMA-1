...
SET TargetVisualStudioAssemblyVersion=15.0.0.0
SET TargetVisualStudioAssemblySuffix=.15.0
SET TargetVisualStudioFrameworkAssemblyVersion=4.6.0.0
SET TargetVisualStudioFrameworkAssemblySuffix=.15.0
SET TargetVisualStudioLongProductYear=2017
SET TargetVisualStudioShortProductYear=17
SET "TargetVisualStudioLongProductName=Visual Studio 2017"
SET TargetVisualStudioShortProductName=VS2017
SET TargetDslToolsAssemblyVersion=15.0.0.0
