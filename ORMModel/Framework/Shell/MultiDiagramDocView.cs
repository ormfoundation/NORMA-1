...
namespace ORMSolutions.ORMArchitect.Framework.Shell
{
	...
	public abstract partial class MultiDiagramDocView : DiagramDocView, IModelingEventSubscriber
	{
        ...
        // HACK: Pulling in a DPI bug fix from Matt's repo: https://github.com/ormsolutions/NORMA/commit/90fea37baa472e16dcc9707056c0c0f94c6d159d
        // This will need to be removed once Microsoft has fixed the issue
#if VISUALSTUDIO_16_0
        private static System.Reflection.MethodInfo getDpiState;
		private static System.Reflection.MethodInfo forceRecreate;
		...
		public override VSDiagramView CreateDiagramView()
		{
			...
			if (forceRecreate == null)
			{
				...
				forceRecreate = typeof(Control).GetMethod("RecreateHandle", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Public);
				getDpiState = typeof(Control).GetMethod("get_DpiAwarenessContext", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);
			}
